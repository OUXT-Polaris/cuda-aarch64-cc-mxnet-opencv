...
curl -o opencv.zip -L https://github.com/opencv/opencv/archive/4.5.0.zip
unzip opencv

# download contrib package
curl -o ./opencv_extra_4.5.0.zip https://codeload.github.com/opencv/opencv_contrib/zip/4.5.0
unzip opencv_extra_4.5.0.zip
